...
# read the babI task data into arrays. Example task data:
...
file = pd.read_csv('data/babI/tasks_1-20_v1-2/en/qa1_single-supporting-fact_train.txt', header=None)
...
print task_count, facts[10], questions[10], answers[10], supporting_facts[10]